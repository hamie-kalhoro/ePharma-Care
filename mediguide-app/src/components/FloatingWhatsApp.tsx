...
export default function FloatingWhatsApp() {
  return (
    <div className="fixed bottom-[96px] end-6 z-50 pointer-events-none">
      {/* Floating Action Button */}
      <a
        href="https://wa.me/923001234567" // Placeholder number
        target="_blank"
        rel="noopener noreferrer"
        className="pointer-events-auto flex items-center justify-center bg-[#25D366] hover:bg-[#1ebd5a] text-white rounded-full shadow-2xl hover:shadow-[#25D366]/40 transition-all duration-300 relative focus:outline-none focus:ring-4 focus:ring-[#25D366]/30 w-14 h-14 group"
